  ...
  return (
    <div className={classes.content}>
      <div className={classes['flex-container-space-between']}>
        ...
        <Button type="primary">
          <Link to={buildRouterLink('/tickets/edit/' + ticketData?._id)}>
            Edit Ticket
          </Link>
        </Button>
      </div>
      ...
      <p
        dangerouslySetInnerHTML={{
          __html: md.render(ticketData.description || ''),
        }}
      ></p>
      {ticketData.relatedTickets?.length > 0 && (
        <RelatedTicketsSection relatedTickets={ticketData.relatedTickets} />
      )}
      ...
      <Row gutter={[16, 16]} className={classes.listRow}>
        ...
        <Col span={8}>
          Last update: {new Date(ticketData.updatedAt).toDateString()}
        </Col>
